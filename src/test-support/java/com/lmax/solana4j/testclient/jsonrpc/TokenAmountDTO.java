...
import com.lmax.solana4j.testclient.api.SolanaRpcResponse;
import com.lmax.solana4j.testclient.api.TokenAmount;
...
final class TokenAmountDTO implements SolanaRpcResponse<TokenAmount>
{
    ...
    @Override
    public TokenAmountValueDTO getValue()
    {
        return value;
    }
    ...
    public static final class TokenAmountValueDTO implements TokenAmount
    {
