...
public abstract class TokenProgramBase
{
    ...
    {
        return TokenProgramBase.initializeAccount(getProgramId(), account, mint, owner);
    }
    ...
    {
        return TokenProgramBase.initializeMint(getProgramId(), tokenMintAddress, decimals, mintAuthority, freezeAuthority);
    }
    ...
    {
        return TokenProgramBase.mintTo(getProgramId(), mint, authority, destination);
    }
    ...
    {
        return TokenProgramBase.transfer(getProgramId(), source, destination, owner, amount, signers);
    }
    ...
    {
        return TokenProgramBase.initializeMultisig(getProgramId(), multisigPublicKey, signers, requiredSignatures);
    }
