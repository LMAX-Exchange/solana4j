...
public interface TransactionResponse
{
    ...
    interface TransactionMetadata
    {
        ...
        /**
         * Returns the total cost-model units charged for the transaction.
         * Cost units represent the cost-model weight assigned to the transaction by the validator.
         *
         * @return the number of cost units charged
         */
        long getCostUnits();
        ...
        /**
         * Returns the most recent program return data generated during the transaction's execution.
         *
         * @return the {@link ReturnData} object representing return data, or {@code null} if no return data
         */
        ...
        /**
         * Represents return data generated by an instruction during a transaction.
         */
        interface ReturnData
        {
            ...
            /**
             * Returns the data returned by the instruction.
             * The first element contains the data and the second the encoding scheme used.
             *
             * @return a list containing the encoded data and the encoding scheme
             */
            List<String> getData();
        }
